from iberForms.models import CECDisplay
...
def cecDisplayForm(request):
    ...
    return render(request, "iberForms/cecDisplayForm.html", context)
...
def cecDisplay(request):
    ...
    return render(request, "iberForms/cecDisplay.html", context)
